...
u_hat = np.linspace(-1/double_pitch, (1/double_pitch - 1/(Lx_hat*2)), int(Nx_hat*2))
v_hat = np.linspace(1/double_pitch, (-1/double_pitch + 1/(Ly_hat*2)), int(Ny_hat*2))
