...
# i=0
    ...
    # 位相シフト計算
    phase_shift = np.exp(1j * 2 * np.pi * ((O_x_hat-x_hat_origin)*U_hat + (O_y_hat-y_hat_origin)*V_hat))*0+1
    ...
    Nv_hat_pad, Nu_hat_pad = F_pad.shape
...
# Image.fromarray(g_view, mode="L").save("triple_triangle2_reconstruction_pad.bmp", format="BMP")
...
plt.show()
# Image.fromarray(g_abs, mode="L").save("triple_triangle2_reconstruction.bmp", format="BMP")
