...
model_name = os.path.join("triple_triangle.ply")
...
local_vertices = (R @ (Global_vertices[start:end, :] - Global_gravitypoints).T).T     #ローカル座標系での三角形の頂点(z座標は0)
...
Image.fromarray(spectrum_view, mode="L").save("triple_triangle_spectrum_interpolation.bmp", format="BMP")